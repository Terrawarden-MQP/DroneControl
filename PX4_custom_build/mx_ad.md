...
| UART   | Device     | Port            | MQP
| ------ | ---------- | --------------- | ------
| USART1 | /dev/ttyS0 | IO debug        |
| USART2 | /dev/ttyS1 | SERIAL1         | TEL1
| USART3 | /dev/ttyS2 | TELEM2          | TEL2
| UART4  | /dev/ttyS3 | GPS/I2C         | GPS
| USART6 | /dev/ttyS4 | PX4IO           |
| UART7  | /dev/ttyS5 | SERIAL5 CONSOLE | TEL3
| UART8  | /dev/ttyS6 | SERIAL4         | RC

<!-- Note: Got ports using https://github.com/PX4/PX4-user_guide/pull/672#issuecomment-598198434 -->
<!-- Note: PX4 optical flow config for v1.11, not the newest v1.14, parameter names are deprecated! : https://www.youtube.com/watch?v=D-ooFHEtQoo -->
